...
const tinyMceDir = join(root, "node_modules", "tinymce");
...
ensureExists(tinyMceDir, "TinyMCE package directory");
...
console.log(`GitHub Pages bundle with self-hosted TinyMCE prepared in: ${outDir}`);
